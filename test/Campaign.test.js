...
describe('Campaigns', () => {
    ...
    it('marks caller as the campaign manager', async () => {
        ...
        assert.strictEqual(manager, accounts[0], 'manger is wrong');
    });
    ...
    it('allows a manager to make a payment request', async () => {
        ...
        assert.strictEqual(request.description, 'Buy Batteries', 'description is wrong');
    });
    ...
    it('processes request', async () => {
        ...
        assert.ok(balance > 104, 'balance should be greater than 104');
    });
})